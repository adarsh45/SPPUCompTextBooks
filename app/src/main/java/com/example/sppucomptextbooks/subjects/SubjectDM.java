...
//    private TextView subjName;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle(R.string.subject_dm);
...
//        subjName.setText(R.string.subject_dm);
    ...
    public void downloadFile(View view){
        ...
        ref = mStorageRef.child("DM").child(pdfName);
    ...
    BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MotionToast.Companion.darkColorToast(SubjectDM.this,"The PDF can only be accessed through the APP",
                    MotionToast.TOAST_WARNING,
                    MotionToast.GRAVITY_BOTTOM,
                    MotionToast.LONG_DURATION,
                    ResourcesCompat.getFont(SubjectDM.this,R.font.helvetica_regular));
        }
    };
}
