...
public class SubjectDM extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        chap1Btn.setText(R.string.dm_chap1);

        chap2Btn = findViewById(R.id.chap2_btn);
        chap2Btn.setText(R.string.dm_chap2);

        chap3Btn = findViewById(R.id.chap3_btn);
        chap3Btn.setText(R.string.dm_chap3);

        chap4Btn = findViewById(R.id.chap4_btn);
        chap4Btn.setText(R.string.dm_chap4);

        chap5Btn = findViewById(R.id.chap5_btn);
        chap5Btn.setText(R.string.dm_chap5);
    ...
    private void checkIfFileDownloaded(String pdfName, Intent intent){
        ...
        if ( tempFile.exists() ) {
            ...
            Toast.makeText(SubjectDM.this, "Please Wait", Toast.LENGTH_SHORT).show();
        }
        else{
            Toast.makeText(SubjectDM.this,"Please Download the file to prevent data usage", Toast.LENGTH_SHORT).show();
        }
    }
