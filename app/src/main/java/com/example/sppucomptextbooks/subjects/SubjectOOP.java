...
//        subjName.setText(R.string.subject_oop);

        chap1Btn = findViewById(R.id.chap1_btn);
        chap1Btn.setText(R.string.oop_unit1);

        chap2Btn = findViewById(R.id.chap2_btn);
        chap2Btn.setText(R.string.oop_unit2);

        chap3Btn = findViewById(R.id.chap3_btn);
        chap3Btn.setText(R.string.oop_unit3);

        chap4Btn = findViewById(R.id.chap4_btn);
        chap4Btn.setText(R.string.oop_unit4);

        chap5Btn = findViewById(R.id.chap5_btn);
        chap5Btn.setText(R.string.oop_unit5);

        chap6Btn = findViewById(R.id.chap6_btn);
        chap6Btn.setText(R.string.dm_unit6);
    ...
    public void openPdf(View view) {
        Intent intent = new Intent(SubjectOOP.this, PDFViewer.class);
        switch (view.getId()){
            case R.id.chap1_btn:
                pdfName = "OOP_UNIT_1_protected.pdf";
                checkIfFileDownloaded(pdfName, intent, btn1);
                break;
            case R.id.chap2_btn:
                pdfName = "OOP_UNIT_2_protected.pdf";
                checkIfFileDownloaded(pdfName, intent, btn2);
                break;
            case R.id.chap3_btn:
                pdfName = "OOP_UNIT_3_protected.pdf";
                checkIfFileDownloaded(pdfName, intent, btn3);
                break;
            case R.id.chap4_btn:
                pdfName = "OOP_UNIT_4_protected.pdf";
                checkIfFileDownloaded(pdfName, intent, btn4);
                break;
            case R.id.chap5_btn:
                pdfName = "OOP_UNIT_5_protected.pdf";
                checkIfFileDownloaded(pdfName, intent, btn5);
                break;

            case R.id.chap6_btn:
                pdfName = "OOP_UNIT_6_protected.pdf";
    ...
    public void downloadFile(View view){
        ...
        ref = mStorageRef.child("OOP").child(pdfName);
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url = uri.toString();
                downloadFileManager(SubjectOOP.this, pdfName.replace(".pdf", ""), ".pdf", DIRECTORY_DOWNLOADS, url);
            }
    ...
    BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MotionToast.Companion.darkColorToast(SubjectOOP.this,"The PDF can only be accessed through the APP",
                    MotionToast.TOAST_WARNING,
                    MotionToast.GRAVITY_BOTTOM,
                    MotionToast.LONG_DURATION,
                    ResourcesCompat.getFont(SubjectOOP.this,R.font.helvetica_regular));
        }
    };
}
