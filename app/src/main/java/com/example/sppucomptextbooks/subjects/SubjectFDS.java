...
//        subjName.setText(R.string.subject_fds);
        ...
        chap1Btn.setText(R.string.fds_unit1);

        chap2Btn = findViewById(R.id.chap2_btn);
        chap2Btn.setText(R.string.fds_unit2);

        chap3Btn = findViewById(R.id.chap3_btn);
        chap3Btn.setText(R.string.fds_unit3);

        chap4Btn = findViewById(R.id.chap4_btn);
        chap4Btn.setText(R.string.fds_unit4);

        chap5Btn = findViewById(R.id.chap5_btn);
        chap5Btn.setText(R.string.fds_unit5);

        chap6Btn = findViewById(R.id.chap6_btn);
        chap6Btn.setText(R.string.deld_unit6);
...
//     PDF buttons
    ...
    private void checkIfFileDownloaded(String pdfName, Intent intent, ImageButton btnID){
        ...
        if ( tempFile.exists() ) {
            ...
            Toast.makeText(SubjectFDS.this,"Please Download the file to prevent data usage", Toast.LENGTH_SHORT).show();
        }
    }

    public void downloadFile(View view){
        mStorageRef = FirebaseStorage.getInstance().getReference();
        ref = mStorageRef.child("FDS").child(pdfName);
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url = uri.toString();
                downloadFileManager(SubjectFDS.this, pdfName.replace(".pdf", ""), ".pdf", DIRECTORY_DOWNLOADS, url);
            }
    ...
    BroadcastReceiver onDownloadComplete = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            MotionToast.Companion.darkColorToast(SubjectFDS.this,"The PDF can only be accessed through the APP",
                    MotionToast.TOAST_WARNING,
                    MotionToast.GRAVITY_BOTTOM,
                    MotionToast.LONG_DURATION,
                    ResourcesCompat.getFont(SubjectFDS.this,R.font.helvetica_regular));
        }
    };
}
